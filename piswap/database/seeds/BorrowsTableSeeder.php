...
class BorrowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('borrows')->insert(array(
            array('date_from' => $faker->dateTimeBetween($startDate = '-60 days', $endDate = '-30 days'), 'date_to' => $faker->dateTimeBetween('-30 days', 'now'), 'user_email' => 'eget.ipsum.Donec@necmollisvitae.edu', 'book_isbn' => '875-8-45-610472-4'),
            array('date_from' => $faker->dateTimeBetween($startDate = '-30 days', $endDate = 'now'), 'date_to' => $faker->dateTimeBetween('now', '+30 days'), 'user_email' => 'eget.ipsum.Donec@necmollisvitae.edu', 'book_isbn' => '875-8-45-610472-4'),
            array('date_from' => $faker->dateTimeBetween($startDate = '-30 days', $endDate = 'now'), 'date_to' => $faker->dateTimeBetween('now', '+30 days'), 'user_email' => 'eget.ipsum.Donec@necmollisvitae.edu', 'book_isbn' => '399-5-21-597320-2'),
